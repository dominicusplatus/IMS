...
{
public class MongoRepository : IIotRepository
	{

		public MongoDbContext _mongoDbContext = null;
		...
		/// <param name="update"></param>
		/// <returns></returns>
		public  ReplaceOneResult ReplaceOne<TEntity>(string id, FilterDefinition<TEntity> filter, TEntity entity, bool upsert) where TEntity : class, new()
		{
            var collection = GetCollection<TEntity>();
            return collection.ReplaceOne(filter ,entity,new UpdateOptions { IsUpsert = upsert });
		}
